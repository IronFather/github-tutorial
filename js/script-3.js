...
// // SPREAD В ОБЪЕКТАХ ДЛЯ КОПИРОВАНИЯ ЭЛЕМЕНТОВ
...
// лишнее убираем через delete vova.position (как пример удаления должности)

// console.log(sara);

// !!! МІНУС !!! НАСЛЕДОВАНИЕ ЭЛЕМЕНТОВ ПРИ ПЕРЕБОРЕ FOR IN (ТОГДА ИСПОЛЬЗУЕМ hasOwnProperty)

// =================================================================================================

// БЕЗ PUSH - ТОП УРОВЕНЬ ПРОГРАМИРОВАНИЯ:
// В МАССИВ/ОБЪЕКТ ПОСЛЕ ЗНАКА РАВЕНСТВА РАСПЫЛЯЕМ ПРЕДЫДУЩИЙ МАССИВ/ОБЪЕКТ С ДОБАВЛЕНИЕМ НОВОГО ЭЛЕМЕНТА
// function myPush (newArr, ... previousRest) {
//     return [...newArr, ... previousRest];
// }

// =================================================================================================

// ГЕНЕРАЦИЯ РЕНДОМНОГО ID - Math.random().toString().slice(2) 
// или Date.now()
// =================================================================================================
